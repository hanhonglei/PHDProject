...
public:
	...
	//  [3/28/2012 Han]
	double AdjustLOD(float d, float l, double fPixelInMeter);
};
...
public:
	...
	bool DecimateByError(double QError);


    void apply_contraction(const MxPairContraction& conx, bool bUpdateMSDM = false);
