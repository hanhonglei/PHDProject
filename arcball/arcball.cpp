...
vec_arcball ab_start = vec_arcball(0,0,1);
vec_arcball ab_curr = vec_arcball(0,0,1);
vec_arcball ab_eye = vec_arcball(0,0,1);
vec_arcball ab_eyedir = vec_arcball(0,0,1);
vec_arcball ab_up = vec_arcball(0,1,0);
vec_arcball ab_out = vec_arcball(1,0,0);
...
void arcball_setzoom(float radius, vec_arcball eye, vec_arcball up)
{
...
static vec_arcball sphere_coords(GLdouble mx, GLdouble my)
{
  GLdouble ax,ay,az;

  gluUnProject(mx,my,0,ab_glm,ab_glp,ab_glv,&ax,&ay,&az);
  vec_arcball m = vec_arcball((float)ax,(float)ay,(float)az) - ab_eye;
...
static vec_arcball planar_coords(GLdouble mx, GLdouble my)
{
  GLdouble ax,ay,az;
  ...
  vec_arcball d = ab_eye + m*t;

  return vec_arcball(d*ab_up,d*ab_out,0.0);
}
...
void arcball_move(int mx, int my)
{
  if(ab_planar)
  {
    ...
    vec_arcball cross = (ab_start^ab_curr).unit() * sina;
